...
class Level():
    def __init__(self, data, screen):
        ...
        self.tile_list_in = []
        self.screen = screen
        self.klocekg_png = pygame.image.load('klocek_green.png')
        self.klocekg_png = pygame.transform.scale(self.klocekg_png,(80,30))
        self.klocekb_png = pygame.image.load('klocek.png')
        self.klocekb_png = pygame.transform.scale(self.klocekb_png,(80,30))
        self.klocekr_png = pygame.image.load('klocek_red.png')
        self.klocekr_png = pygame.transform.scale(self.klocekr_png,(80,30))
        self.klocekin_png = pygame.image.load('inbrick.png')
...
class Game():
    def __init__(self, gra):
        ...
        self.bg_png = pygame.image.load("newbg.png").convert()
        ...
        self.trace1 = pygame.image.load("trace1.png").convert_alpha()
        self.trace2 = pygame.image.load("trace2.png").convert_alpha()
        self.trace3 = pygame.image.load("trace3.png").convert_alpha()
        self.des1 = pygame.image.load("desg1.png").convert_alpha()
        self.des2 = pygame.image.load("desg2.png").convert_alpha()
        self.des3 = pygame.image.load("desg3.png").convert_alpha()
        self.des4 = pygame.image.load("desg4.png").convert_alpha()
        self.des5 = pygame.image.load("desg5.png").convert_alpha()
        self.des6 = pygame.image.load("desg6.png").convert_alpha()
        self.des7 = pygame.image.load("desg7.png").convert_alpha()
        self.des8 = pygame.image.load("desg8.png").convert_alpha()
        self.des9 = pygame.image.load("desg9.png").convert_alpha()
        self.des10 = pygame.image.load("desg10.png").convert_alpha()
        self.des = [self.des1,self.des2,self.des3,self.des4,self.des5,self.des6,self.des7,self.des8,self.des9,self.des10]
        self.heart_png = pygame.image.load("heart.png").convert_alpha()
    ...
    def dzwiek(self, sound):
        sound = pygame.mixer.Sound(f"{sound}.wav")
